...
glimpse(d)
ggplot (data = d |> drop_na (Trophic. Level), aes (x = Trophic. Level, y = log(Mass))) + geom\ boxplot()+geom\ jitter()
ggplot(data = d |> drop_na (Migration), as.factor (Migration), y =log(Mass))) + geom_boxplot() aes ( x =
